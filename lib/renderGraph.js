...
const shapeFromType = t => {
    let s;
    switch (t) {
        case "(": s = "terminal"; break;
        case "[": s = "process"; break;
        case "/": s = "io"; break;
        case "<": s = "decision"; break;
        case "|": s = "predefined"; break;
        case "~": s = "document"; break;
        case "{": s = "storage"; break;
        case "C": s = "comment"; break;
        case "$": s = "manual_input"; break;
        case "`": s = "manual_operation"; break;
        ...
        if (err) {
            ...
            if (nodes === undefined) {
                ...
                graph.nodes().forEach(iv => {
                    ...
                    xw.startElement("g");
                        xw.startElement("use");
                            xw.writeAttribute("xlink:href", "#"+shapeFromType(v.type));
